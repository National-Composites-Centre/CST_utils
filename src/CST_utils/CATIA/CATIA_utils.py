...
#The series of functions here should be made into module - i.e. runnable with any CompoST file to display/store things
#This would be useful as the code is beings used in various places
#TODO version control this and make it pip-installable, give installation instructions in docs
